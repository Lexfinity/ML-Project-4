...
print("Accuracy:", getScoretWithModel(svm, redditDataTrainTF, redditDataTestTF, y_train, y_test))

# x_train, x_test, y_train, y_test = train_test_split(rX, rY, test_size=0.2, random_state=4)
# redditDataTrainTF = cv.fit_transform(x_train)
# redditDataTestTF = cv.transform(x_test)
